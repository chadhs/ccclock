...
Weather data is sourced from the everaging the [OpenWeather API](https://openweathermap.org/api), and written in ClojureScript using: [re-frame](https://github.com/day8/re-frame).
...
* [`src/ccclock/styles.cljs`](src/ccclock/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/ccclock/`](src/ccclock/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/ccclock/core.cljs): contains the SPA entry point, `init`
* [`test/ccclock/`](test/ccclock/): test files (ClojureScript,
...
Edit the config values as necessary in the `config-dev.edn`; you will need a OpenWeather API key.
Then start the api with the command below.  See the following Emacs section to run the API live with hot-reloading of changes.
...
The `debug?` variable in [`config.cljs`](src/cljs/ccclock/config.cljs) defaults to `true` in
